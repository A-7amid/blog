        ...
        <div className="flex gap-5 items-end h-full">
          <div className="flex items-end">
            <div className="flex flex-row items-center ">
              <span className="opacity-60 font-medium text-sm mr-4">
                {date}
              </span>
              <span className="size-4 mr-12 gap-1 opacity-60 items-center font-medium text-sm flex">
                <img src="imgs/like.png" alt="likes" />
                <span>{likes}</span>
              </span>
